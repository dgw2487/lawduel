      ...
      <div className="container mx-auto px-6 md:px-24 animate-[slide-in-right_0.7s_ease-out]">
        ...
        <Accordion type="single" collapsible className="w-full md:max-w-6xl mx-auto">
          <AccordionItem value="item-1">
            <AccordionTrigger className='no-underline p-6'><h4 className='text-2xl no-underline'>Who is LAWDUEL?</h4></AccordionTrigger>
            <AccordionContent className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className='no-underline p-6'><h4 className='text-2xl no-underline'>How does LAWDUEL help you?</h4></AccordionTrigger>
            <AccordionContent className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className='no-underline p-6'><h4 className='text-2xl no-underline'>Want to be a LAWDUEL agent?</h4></AccordionTrigger>
            <AccordionContent className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className='no-underline p-6'><h4 className='text-2xl no-underline'>Why you choose LAWDUEL?</h4></AccordionTrigger>
            <AccordionContent className='bg-white p-6 rounded-lg shadow-md'>
